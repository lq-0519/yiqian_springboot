...
public class InvitationCodeController {
    ...
    public ModelAndView findAll(@RequestParam(name = "page", defaultValue = "1") Integer page,
        ...
        // 分页查询
        List<InvitationCode> invitationCodes = invitationCodeService.findByCondition(condition, page, 40);
        PageInfo<InvitationCode> pageInfo = new PageInfo<>(invitationCodes);
    ...
    public ModelAndView showInvitationCodeDetials(@RequestParam(name = "id") String id,
        ...
        // 存储查出来的邀请码的详细信息
        modelAndView.addObject("invitationCode", invitationCode);
        modelAndView.addObject("pageInfo", pageInfo);
